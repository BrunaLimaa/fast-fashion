...
<head>
    ...
    <link rel="stylesheet" href="<?= url("assets/web/css/styles1.css"); ?>">
    ...
    <div class="barra-nav">
        ...
        <nav>
            <ul id="menuItems">
                ...
                <li><a href="#">Produtos</a>
                    <ul class="dropdown">
                        ...
                        foreach ($categories as $category){
                            ...
                            ?>
                            <li>
                            <a class="dropdown-item" href="<?= url("produtos/{$category->id}"); ?>"><?= $category->category;?></a>
                            </li>
                            <?php
                        }
                        ?>
                ...
                <li><a href="<?= url("entrar"); ?>">Carrinho</a></li>
